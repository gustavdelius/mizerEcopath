...
#BTS
BTS <- getDATRAS(record = "HL", survey = "BTS", year = 1985:2024, quarter = 1:4)
...
SCOROC_HL_CA<-left_join(SCOROC,SCOROC_CA, by=c("Survey","Quarter", "Country", "Ship", "Gear","SweepLngt","GearEx","DoorType","StNo","HaulNo","Year","SpecCode"))
...
BTS_CA <- BTS_CA %>%
  select(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, AreaCode) %>%
  distinct(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, .keep_all = TRUE)
BTS_HL_CA<-left_join(BTS,BTS_CA, by=c("Survey","Quarter", "Country", "Ship", "Gear","SweepLngt","GearEx","DoorType","StNo","HaulNo","Year","SpecCode"))
...
DYFS_CA <- DYFS_CA %>%
  select(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, AreaCode) %>%
  distinct(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, .keep_all = TRUE)
DYFS_HL_CA<-left_join(DYFS,DYFS_CA, by=c("Survey","Quarter", "Country", "Ship", "Gear","SweepLngt","GearEx","DoorType","StNo","HaulNo","Year","SpecCode"))
...
ROCKALL_CA <- ROCKALL_CA %>%
  select(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, AreaCode) %>%
  distinct(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, .keep_all = TRUE)
ROCKALL_HL_CA<-left_join(ROCKALL,ROCKALL_CA, by=c("Survey","Quarter", "Country", "Ship", "Gear","SweepLngt","GearEx","DoorType","StNo","HaulNo","Year","SpecCode"))
...
IE_IGFS_CA <- IE_IGFS_CA %>%
  select(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, AreaCode) %>%
  distinct(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, .keep_all = TRUE)
IE_IGFS_HL_CA<-left_join(IE_IGFS,IE_IGFS_CA, by=c("Survey","Quarter", "Country", "Ship", "Gear","SweepLngt","GearEx","DoorType","StNo","HaulNo","Year","SpecCode"))
...
FR_CGFS_CA <- FR_CGFS_CA %>%
  select(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, AreaCode) %>%
  distinct(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, .keep_all = TRUE)
FR_CGFS_HL_CA<-left_join(FR_CGFS,FR_CGFS_CA, by=c("Survey","Quarter", "Country", "Ship", "Gear","SweepLngt","GearEx","DoorType","StNo","HaulNo","Year","SpecCode"))
...
IE_IAMS_CA <- IE_IAMS_CA %>%
  select(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, AreaCode) %>%
  distinct(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, .keep_all = TRUE)
IE_IAMS_HL_CA<-left_join(IE_IAMS,IE_IAMS_CA, by=c("Survey","Quarter", "Country", "Ship", "Gear","SweepLngt","GearEx","DoorType","StNo","HaulNo","Year","SpecCode"))
...
SP_PORC_CA <- SP_PORC_CA %>%
  select(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, AreaCode) %>%
  distinct(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, .keep_all = TRUE)
SP_PORC_HL_CA<-left_join(SP_PORC,SP_PORC_CA, by=c("Survey","Quarter", "Country", "Ship", "Gear","SweepLngt","GearEx","DoorType","StNo","HaulNo","Year","SpecCode"))
...
EVHOE_CA <- EVHOE_CA %>%
  select(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, AreaCode) %>%
  distinct(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, .keep_all = TRUE)
EVHOE_HL_CA<-left_join(EVHOE,EVHOE_CA, by=c("Survey","Quarter", "Country", "Ship", "Gear","SweepLngt","GearEx","DoorType","StNo","HaulNo","Year","SpecCode"))
...
NS_IBTS_CA <- NS_IBTS_CA %>%
  select(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, AreaCode) %>%
  distinct(Survey, Quarter, Country, Ship, Gear, SweepLngt, GearEx, DoorType, StNo, HaulNo, Year, SpecCode, .keep_all = TRUE)
NS_IBTS_HL_CA<-left_join(NS_IBTS,NS_IBTS_CA, by=c("Survey","Quarter", "Country", "Ship", "Gear","SweepLngt","GearEx","DoorType","StNo","HaulNo","Year","SpecCode"))
```
...
#make the coversion
cs_data_length_corrected<-cs_data%>%
...
```{r}
survey <- cs_data_length_corrected %>%
...
total_survey$count <- total_survey$catch
```
