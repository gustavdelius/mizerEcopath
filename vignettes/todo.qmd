...
If size at age data is not available but only von Bertalanffy parameters, we could create synthetic data by adding noise to the length, using the same model that was used to estimate the von Bertalanffy parameters.
