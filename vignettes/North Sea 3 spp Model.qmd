...
sp <- 
    readRDS(here::here("inst", "extdata", "ns_3_spp_params.rds"))
head(sp)
```
...
colnames(ecopath_catch)[2] <- "Group.name"
ecopath_catch <- left_join(ecopath_params, ecopath_catch, by = c("Group.name" = "Group.name")) |>
