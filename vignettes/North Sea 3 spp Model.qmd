...
remotes::install_github("sizespectrum/mizer",force=TRUE)
remotes::install_github("gustavdelius/mizerEcopath", force=TRUE)
```
...
ecopath_params <- read.csv("inst/extdata/North Sea-Basic estimates.csv")
#
ecopath_diet <- read.csv("inst/extdata/North Sea-Diet composition.csv")
#
landings <- readRDS("inst/extdata/ns_catch.rds")
landings <- landings[landings$gear == "total", ] #select total gear only
landings <- landings %>%
  mutate(length = ceiling(length)) %>%           # Round up lengths
...
#Ecopath catch data
catch <- read.csv("inst/extdata/North Sea-Landings.csv")
...
life_histories<-read_csv("/Users/jessicawestworth/Desktop/North Sea 3 spp params.csv")
...
sp<-readRDS("/Users/jessicawestworth/Desktop/Mizer Work/Projects/mizerEcopathedits/inst/extdata/ns_3_spp_params.rds")
...
dm<-readRDS("/Users/jessicawestworth/Desktop/Mizer Work/Projects/mizerEcopathedits/inst/extdata/ns_3_spp_model_adjusted_diet_matrix.rds")

#inital model
initial<-readRDS("/Users/jessicawestworth/Desktop/Mizer Work/Projects/mizerEcopathedits/Data/ns_3_spp_model_initial.rds")
#trial model
trial<-readRDS("/Users/jessicawestworth/Desktop/Mizer Work/Projects/mizerEcopathedits/Data/ns_3_spp_model_trial.rds")
#final model
final<-readRDS("/Users/jessicawestworth/Desktop/Mizer Work/Projects/mizerEcopathedits/Data/ns_3_spp_model_final.rds")
...
#saveRDS(sp, "/Users/jessicawestworth/Desktop/Mizer Work/Projects/mizerEcopathedits/inst/extdata/ns_3_spp_params.rds")
```
...
#saveRDS(dm, "/Users/jessicawestworth/Desktop/Mizer Work/Projects/mizerEcopathedits/inst/extdata/ns_3_spp_model_adjusted_diet_matrix.rds")
```
...
p_backup <- p
#saveRDS(p, "/Users/jessicawestworth/Desktop/Mizer Work/Projects/mizerEcopathedits/Data/ns_3_spp_model_initial.rds")
```
...
p_tuned_backup<-p_tuned
#saveRDS(p_tuned, "/Users/jessicawestworth/Desktop/Mizer Work/Projects/mizerEcopathedits/Data/ns_3_spp_model_trial.rds")
p_tuned<-readRDS("/Users/jessicawestworth/Desktop/Mizer Work/Projects/mizerEcopathedits/Data/ns_3_spp_model_trial.rds")
...
#saveRDS(p_tuned1, "/Users/jessicawestworth/Desktop/Mizer Work/Projects/mizerEcopathedits/Data/ns_3_spp_model_final.rds")
```
